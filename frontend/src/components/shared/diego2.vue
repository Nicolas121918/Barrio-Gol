<template>
    ...
    <div class="negro">
      <div class="match-container">
        ...
        <!-- Interfaz de Ganador y Perdedor -->
        <div v-if="ganadorr === 'equipo_a' || ganadorr === 'equipo_b'" class="modal">
            ...
            <div class="result-container">
              ...
              <div class="team-result winner">
                <div class="team-logo-container">
                  ...
                  <img :src="ganadorr === 'equipo_a' ? teamA.logo : teamB.logo" alt="Logo Equipo Ganador" class="team-logo-modal1" />
                </div>
                <p class="ganr">{{ ganadorr === 'equipo_a' ? teamA.name : teamB.name }} - {{ ganadorr === 'equipo_a' ? teamA.goles : teamB.goles }} goles</p>
              ...
              <div class="team-result">
                <div class="team-logo-container">
                  ...
                  <img :src="ganadorr === 'equipo_a' ? teamB.logo : teamA.logo" alt="Logo Equipo Perdedor" class="team-logo-modal" />
                </div>
                <p class="ganr">{{ ganadorr === 'equipo_a' ? teamB.name : teamA.name }} - {{ ganadorr === 'equipo_a' ? teamB.goles : teamA.goles }} goles</p>
    ...
    data() {
      return {
        ...
        teamB: {
          ...
          goles: 10, // Variable para goles
        },
        isMatchStarted: false,
        ganadorr: "equipo_b", // Nueva variable
      };
    },
    mounted() {
      const now = new Date();
      const matchDateTime = new Date();
      matchDateTime.setHours(19, 0, 0); // Hoy a las 7:00 PM
